package com.dermitio.chaoschunks.server.notice;
...
private static boolean isChaosWorld(MinecraftServer server) {
    try {
        ...
        return acc.chaoschunks$getBiomeSource() instanceof com.dermitio.chaoschunks.worldgen.biome.ChaosBiomeSource;
